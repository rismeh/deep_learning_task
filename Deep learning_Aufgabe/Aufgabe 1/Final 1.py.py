...
# Loading the data (car/non-car)
train_set_x_orig, train_set_y, test_set_x_orig, test_set_y, classes = load_dataset()
print(classes)

# Example of a picture
index = 50  #when i change index value, its also change to car and non car
plt.imshow(train_set_x_orig[index])
print ("y = " + str(train_set_y[:, index]) + ", it's a '" + str(classes[train_set_y[:, index]]) +  "' picture.")
